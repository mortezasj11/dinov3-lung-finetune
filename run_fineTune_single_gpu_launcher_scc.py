...
def run_training():
    ...
    parser.add_argument("--csv", type=str, 
                       default='/rsrch7/home/ip_rsrch/wulab/Lung_Foundation_Model_Data_/Down-stream_tasks/Histology/FineTune/CSVs/ready_finetune_t1919_v500_all_info.csv', 
                       help="Path to the CSV file containing dataset information")
    
    # Group definitions for mutually exclusive tasks
    parser.add_argument("--groups", type=str,
                       default="[['is_scc', 'is_adenocarcinoma', 'is_other']]",
    ...
    parser.add_argument("--output", type=str, 
                       default=os.path.join("/rsrch7/home/ip_rsrch/wulab/Lung_Foundation_Model_Data_/Down-stream_tasks/Histology/FineTune/output/outputSep24_SCC/", OUTPUT_DIR),
                       help="Output directory for logs and checkpoints")
    parser.add_argument("--print-every", type=int, default=600, 
                       help="Print training stats every N steps")
    parser.add_argument("--val-every", type=int, default=3000, 
